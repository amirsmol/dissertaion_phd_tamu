...
\include{../titlepage}  % This is simply a file that formats and adds your
% \include{abstract}
% \include{lists}  % This is simply a file that formats and adds your toc, lof,
% \include{chap_01_introduction}
% \include{chap_02_constitutive_model_for_polarization_switching}
% \include{chap_03_minor_loop_constitutive_model_for_polarized_piezo_electric}
% \include{chap_04_structural_analyses}
% \include{chap_05_active_trusses} 
% \include{chap_06_conclusion}
%  \include{chap_06_thermodynamically_consistent_polarization_model}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
