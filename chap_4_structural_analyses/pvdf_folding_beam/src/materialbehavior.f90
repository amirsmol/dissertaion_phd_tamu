...
! ================================================================ pvdf
real(iwp),parameter::ec=45; !kV/mm
real(iwp),parameter::pr_sat=8e-2;
real(iwp),parameter::eps_s_r=3.0e-3;
real(iwp),parameter::c=16.67;
real(iwp),parameter::eta=1.0;
...
!real(iwp),parameter::alpha_axial_pvdf = 4.6e-4; !N/(kV.mm)
!real(iwp),parameter::alpha_later_pvdf = -8.09e-6; !N/(kV.mm)
!real(iwp),parameter::alpha_shear_pvdf = -2.7e-1;  !N/(kV.mm)
!
!real(iwp),parameter::lambda_pvdf =1.59e2; ! N/mm^2
!real(iwp),parameter::mu_pvdf = 1.0705e2;  ! N/mm^2
!real(iwp),parameter::eps_pvdf = 10.62e-3; !mC/(kV.m)
...
!if(norm_vect(electric_field).lt.3*ec)then
