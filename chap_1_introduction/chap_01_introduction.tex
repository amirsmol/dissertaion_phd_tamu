...
The telescopic actuators \cite{Alexander2003,Alexander}, piezo stack actuators \cite{Ardelean2004}, and active fiber composites \cite{ben2010temperature} are devices utilizing several actuation architectures.
...
Macareno et al. \cite{Macareno2008346} considered a linear truss made of 3D tetrahedral units for Variable Geometry Trusses (VGTs). 
